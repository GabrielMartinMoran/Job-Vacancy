...
Then('Email {string} and expected remuneration {float} should be stored for {string} offer') do |email, expected_remuneration, job_offer_title|
  ...
  expect(job_application.applicant_email).to eq email
