...
describe SuggestedOffers do
  ...
  let!(:main_offer) do
    JobOffer.new(id: 1, is_active: true, title: 'a title', tags: 'programmer,web,ruby')
  end
  ...
  context 'when obtain' do
    ...
    it 'should return empty array when none offer match tags' do
      job_offer = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: '')
      suggested_offers.add([job_offer])
      expect(suggested_offers.obtain).to eq []
    end

    it 'should return one offer in array when one offer match tags' do
      job_offer = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'programmer,web,ruby')
      suggested_offers.add([job_offer])
      expect(suggested_offers.obtain).to eq [job_offer]
    end

    it 'should return one offer in array when one offer match some tag' do
      job_offer = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'ruby')
      suggested_offers.add([job_offer])
      expect(suggested_offers.obtain).to eq [job_offer]
    end

    it 'should return two offers in array when two offers match some tags' do
      job_offer1 = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'ruby')
      job_offer2 = JobOffer.new(id: 3, is_active: true, title: 'a title', tags: 'programmer')
    ...
    it 'should return three offers in array when three offers match some tags' do
      job_offer1 = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'ruby')
      job_offer2 = JobOffer.new(id: 3, is_active: true, title: 'a title', tags: 'programmer')
      job_offer3 = JobOffer.new(id: 4, is_active: true, title: 'a title', tags: 'programmer')
    ...
    it 'should return only three offers in array when four offers match some tags' do
      job_offer1 = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'ruby')
      job_offer2 = JobOffer.new(id: 3, is_active: true, title: 'a title', tags: 'programmer')
      job_offer3 = JobOffer.new(id: 4, is_active: true, title: 'a title', tags: 'web')
      job_offer4 = JobOffer.new(id: 5, is_active: true, title: 'a title', tags: 'programmer')
    ...
    it 'should return offers in array sorted by number of tag matches' do
      job_offer1 = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'ruby')
      job_offer2 = JobOffer.new(id: 3, is_active: true, title: 'a title', tags: 'programmer,web')
      suggested_offers.add([job_offer1, job_offer2])
    ...
    it 'should return offers in array sorted by number of tag matches plus' do
      job_offer1 = JobOffer.new(id: 2, is_active: true, title: 'a title', tags: 'ruby')
      job_offer2 = JobOffer.new(id: 3, is_active: true, title: 'a title', tags: 'programmer,web,ruby')
      job_offer3 = JobOffer.new(id: 4, is_active: true, title: 'a title', tags: 'programmer,web')
      suggested_offers.add([job_offer1, job_offer2, job_offer3])
    ...
    it 'should not return non active offers in array' do
      job_offer = JobOffer.new(id: 2, is_active: false, title: 'a title', tags: 'ruby')
      suggested_offers.add([job_offer])
